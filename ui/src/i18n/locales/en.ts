...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    growth: {
      ...
      subtitle: "Latest action and alert state from the shared workspace memory.",
      unavailable: "No growth foundation snapshot found under workspace memory.",
      alert: "Alert",
      actions: "Actions",
      ...
      codexSmoke: "Codex Smoke",
      codexSmokePeriod: "Smoke period",
      codexReviewSmoke: "Review Smoke",
      codexReviewSmokePeriod: "Review period",
      backfills: "Backfills",
      ...
      reopen: "Reopen",
      updating: "Updating…",
      updateFailed: "Review state update failed",
      none: "none",
    },
    auth: {
